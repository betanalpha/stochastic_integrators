...
\begin{figure}
\centering
\subfigure[]{\includegraphics[width=1.665in]{full_level_set.eps}}
\subfigure[]{\includegraphics[width=1.665in]{small_batch_level_set.eps}}
\subfigure[]{\includegraphics[width=1.665in]{large_batch_level_set.eps}}
